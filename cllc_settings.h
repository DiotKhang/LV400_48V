...
#define SEC_PWM_DEADBAND_RED_NS  ((float32_t)200)
#define SEC_PWM_DEADBAND_FED_NS  ((float32_t)200)
...
#define CONTROL_PRECHARGE_TPBRD_MAX (CPU_SYS_CLOCK_FREQ_HZ / NOMINAL_PWM_SWITCHING_FREQUENCY_HZ / 2.0f)
